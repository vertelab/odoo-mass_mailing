...
{
    'name': 'Mass Mailing: RoundRobin Mail Server selector',
    'version': '14.0.0.0.0',
    # Version ledger: 14.0 = Odoo version. 1 = Major. Non regressionable code. 2 = Minor. New features that are regressionable. 3 = Bug fixes
    'summary': 'Proof of concept to send emails to different outgoing mail servers.',
    ...
    #'sequence': '1',
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-mass_mailing/mail_rr_outgoing',
